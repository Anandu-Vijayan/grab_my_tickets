...
// Placeholder TICKET_STATUS Enum (Define this somewhere globally in your codebase)
// const TICKET_STATUS = {
//   VALID: "VALID",
//   USED: "USED",
// };
  ...
  handler: async (ctx, { eventId, userId }) => {
    ...
    return {
      ...
      message: available
        ...
        : "Added to waiting list -you'll be notified when a ticket becomes avilabile",
    };
  },
});
