...
const EventList = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      {pastEvents.length > 0 && (
        <>
          <h2 className="text-2xl font-bold text-gary-900 mb-6">Past Events</h2>
          <div className="grid grid-cold-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
